# Day 9: Terraform Dynamic Blocks, Conditional Expressions, and Splat Expressions
...
Proceed to **Day 10** to learn about Terraform's built-in functions and how to use them effectively in your configurations.
