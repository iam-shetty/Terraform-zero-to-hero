...
## Day 2: Advanced Terraform Configuration- AWS Providers
...
#### State Locking with DynamoDB < this technique has been deprecated. Now s3 has default state locking system>
